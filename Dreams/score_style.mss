...
<museScore version="4.70">
  <Style>
    ...
    <measureNumberPlacementMode>below-system</measureNumberPlacementMode>
    ...
    <evenHeaderC>$M $m 
$:workTitle:</evenHeaderC>
    <evenHeaderR></evenHeaderR>
    <oddHeaderL></oddHeaderL>
    <oddHeaderC>$M $m</oddHeaderC>
    ...
    <evenFooterC>$C $M $m
Intended only for use within OTA; No Permission to Arrange Acquired
All Rights Reserved by Original Owners
DO NOT DISTRIBUTE</evenFooterC>
    <evenFooterR></evenFooterR>
    <oddFooterL></oddFooterL>
    <oddFooterC>$M $m
Intended only for use within OTA; No Permission to Arrange Acquired
All Rights Reserved by Original Owners
DO NOT DISTRIBUTE</oddFooterC>
    ...
    <mmRestRangeBracketType>1</mmRestRangeBracketType>
